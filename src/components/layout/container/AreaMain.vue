<template>
  ...
  <div class="area-main">
    ...
    <!-- s_list / 카테고리, 검색 리스트 -->
    <Category :categoryData="categoryData" v-if="isCategoryPage"></Category>

    <!-- area-view / 뷰페이지 및 기본 영역 -->
    <AreaView v-if="!isMainPage"></AreaView>
  </div>
</template>
...
export default {
  ...
  props: {
    cover_item_url: String,
    cover_item_thumbnail: String,
  },
};
</script>
